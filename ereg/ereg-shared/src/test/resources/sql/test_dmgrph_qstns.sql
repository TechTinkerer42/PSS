...
insert into PGM_DMGRPH_QSTN_SET (PGM_CDE,SET_ID,EFF_DT,EXPRTN_DT,DTE_USG_TYP_FLG,DMGRPH_QSTN_SET_TYP_CDE) values ('HSE',1,to_date('01-JAN-2013','DD-MON-YYYY'),to_date('15-DEC-2013','DD-MON-YYYY'),'Y','PRFL');
...
insert into DMGRPH_QSTN (DMGRPH_QSTN_NO,DMGRPH_QSTN_RSP_TYP_CDE,DMGRPH_QSTN_NAM,INTL_CNTNT_ID) values (8,'S','HSET Demo Question8',8);
...
insert into DMGRPH_QSTN_SET_ENTRY (SET_ID,DMGRPH_QSTN_NO,RSP_REQ_FLG,QSTN_DSPLY_SEQ,ADMIN_DSPLY_SEQ) values (1,5,'N',5,5);
insert into DMGRPH_QSTN_SET_ENTRY (SET_ID,DMGRPH_QSTN_NO,RSP_REQ_FLG,QSTN_DSPLY_SEQ,ADMIN_DSPLY_SEQ) values (1,6,'N',6,6);
insert into DMGRPH_QSTN_SET_ENTRY (SET_ID,DMGRPH_QSTN_NO,RSP_REQ_FLG,QSTN_DSPLY_SEQ,ADMIN_DSPLY_SEQ) values (1,7,'N',7,7);
insert into DMGRPH_QSTN_SET_ENTRY (SET_ID,DMGRPH_QSTN_NO,RSP_REQ_FLG,QSTN_DSPLY_SEQ,ADMIN_DSPLY_SEQ) values (1,8,'N',8,8);
...
insert into trnsltn(intl_cntnt_id,lang_cde,trnsltn_txt) values(26,'EN','China');
