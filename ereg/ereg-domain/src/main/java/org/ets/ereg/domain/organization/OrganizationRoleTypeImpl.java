...
@Entity
@Table(name = "ORG_RLE_TYP")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY, region = "etsStandardElements")
public class OrganizationRoleTypeImpl implements OrganizationRoleType,
		Serializable {
	...
	@Id
	@Column(name = "ORG_RLE_TYP_CDE", nullable = false, length = 5)
	private String code;

	@Column(name = "ORG_RLE_TYP_DSC", nullable = false, length = 175)
	private String description;

    @Column(name = "ORG_RLE_TYP_DSPLY_SEQ")
	...
	public boolean equals(final Object obj) {
		if (obj instanceof OrganizationRoleTypeImpl) {
			final OrganizationRoleTypeImpl other = (OrganizationRoleTypeImpl) obj;
