...
import org.hibernate.annotations.Type;
	...
	public class LanguageTypeImpl implements Serializable, LanguageType {
		...
		@Column(name = "LANG_DSC", nullable = false, length = 100)
		...
		public boolean equals(final Object obj) {
			if (obj instanceof LanguageTypeImpl) {
				final LanguageTypeImpl other = (LanguageTypeImpl) obj;
