...
public class AddressTypeImpl implements java.io.Serializable, AddressType {

	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "ADR_PRPS_CDE", nullable = false, length = 5)
	private String code;

	@Column(name = "ADR_PRPS_DSC", nullable = false, length = 100)
	private String description;

	@Column(name = "ADR_PRPS_DSPLY_SEQ")
	...
	public boolean equals(final Object obj) {
		if (obj instanceof AddressTypeImpl) {
			final AddressTypeImpl other = (AddressTypeImpl) obj;
