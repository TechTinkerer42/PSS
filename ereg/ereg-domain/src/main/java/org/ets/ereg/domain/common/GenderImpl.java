...
import org.hibernate.annotations.Type;
	...
	public class GenderImpl implements Serializable, Gender {

		private static final long serialVersionUID = 1L;

		@Id
		@Column(name = "GNDR_CDE", nullable = false, length = 5)
		private String code;

		@Column(name = "GNDR_DSC", nullable = false, length = 100)
		private String description;

	    @Column(name = "GNDR_DSPLY_SEQ")
		...
		public boolean equals(final Object obj) {
			if (obj instanceof GenderImpl) {
				final GenderImpl other = (GenderImpl) obj;
