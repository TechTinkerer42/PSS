...
import org.hibernate.annotations.Type;
	...
	public class MilitaryStatusTypeImpl implements Serializable, MilitaryStatusType {

		private static final long serialVersionUID = 1L;

		@Id
		@Column(name = "MIL_STS_CDE", nullable = false, length = 5)
		private String code;

		@Column(name = "MIL_STS_DSC", nullable = false, length = 100)
		private String description;

	    @Column(name = "MIL_STS_DSPLY_SEQ")
		...
		public boolean equals(final Object obj) {
			if (obj instanceof MilitaryStatusTypeImpl) {
				final MilitaryStatusTypeImpl other = (MilitaryStatusTypeImpl) obj;
