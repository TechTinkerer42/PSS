...
import org.hibernate.annotations.Type;
	...
	@Entity
	@Table(name = "PHONE_TYP")
	@Cache(usage = CacheConcurrencyStrategy.READ_ONLY, region = "etsStandardElements")
	public class PhoneTypeImpl implements Serializable, PhoneType {

		private static final long serialVersionUID = 1L;

		@Id
		@Column(name = "PHONE_TYP_CDE", nullable = false, length = 5)
		private String code;

		@Column(name = "PHONE_TYP_DSC", nullable = false, length = 100)
		private String description;

	    @Column(name = "PHONE_TYP_DSPLY_SEQ")
		...
		public boolean equals(final Object obj) {
			if (obj instanceof PhoneTypeImpl) {
				final PhoneTypeImpl other = (PhoneTypeImpl) obj;
