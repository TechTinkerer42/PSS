...
<t:base title="Home Page">
	...
	<div id="homeContainer">
		...
		<div class="column2">
			...
			<div class="block">
				<h3><spring:message code="home.tests" arguments="${globalContextCustomer.currentProgramShortDescription}"/></h3>
				<div class="content">	
					<span class="homePageh2"><spring:message code="home.upcomingTest.header" arguments="1"/></span>
				</div>

				<br>
				<ul>
					<li><a href="/portfolio/spring/web/task/myPage">Pre-Service Teacher Assessment</a></li>
				</ul>
				<br/>
