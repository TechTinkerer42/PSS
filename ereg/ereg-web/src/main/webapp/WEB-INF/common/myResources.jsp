...
<link href="<c:url value="/resources/css/pssscreen.css"/>" rel="stylesheet" type="text/css" />
			<div class="rounded">
				...
				<p class="like-h3 shaded">My Resources</p>
				<div class="content">
					<ul>
					<li><a href="http://mega.ets.org/rsc/pdf/candidate_educator_handbook.pdf" target="_blank"><spring:message code="tasks.myresources.moPTA"/></a></li>
