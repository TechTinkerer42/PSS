...
public class ETSCustomerRequestHeaderAuthenticationFilter extends RequestHeaderAuthenticationFilter{
	private static Logger logger = LoggerFactory.getLogger(ETSCustomerRequestHeaderAuthenticationFilter.class);
